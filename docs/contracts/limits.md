...
or unavailable rather than silently exceeding the contract. Until reclamation
lands, replacement versions increase file bytes even though resident memory
stays bounded.
