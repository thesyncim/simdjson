...
// projection, containment, and grouping primitives into one compiled plan
// with a programmatic builder and an optional SQL front end. The table is one
// DocSet, each document is a row, and columns are JSON paths. It answers SELECT
// of path projections and aggregates
